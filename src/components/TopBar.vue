			...
			<div class="topbar-nav">
				<ul class="nav-wrap">
					<li v-for="item in navs" class="nav clearfix">
						<template v-if="item.name === 'Bevis Shen'">
...
<script>
	export default {
		data () {
			return {
				navs: [
					{name: 'Bevis Shen Blog', sourceUrl: 'https://utopia1991.github.io'},
					{name: 'Github', sourceUrl: 'https://github.com/utopia1991'},
					{name: 'Wordpress', sourceUrl: 'https://bevis1991.wordpress.com/'},
					{name: 'Facebook', sourceUrl: 'https://www.facebook.com/bevis1991'},
					{name: 'Douban', sourceUrl: 'https://www.douban.com/people/Utopia19910619/'}
				],
				timer: '',
				cartStatus: false
			}
