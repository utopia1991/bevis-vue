			...
			<div class="topbar-nav">
				<ul class="nav-wrap">
					<li v-for="item in navs" class="nav clearfix">
						<template v-if="item.name === 'Bevis 博客'">
...
export default {
	data () {
		return {
			navs: [
				{name: 'Bevis 博客', sourceUrl: 'https://utopia1991.github.io'},
				{name: 'Github 账号', sourceUrl: 'https://github.com/utopia1991'},
				{name: 'Wordpress', sourceUrl: 'https://bevis1991.wordpress.com'},
				{name: 'Facebook', sourceUrl: 'https://www.facebook.com/bevis1991'},
				{name: '豆瓣', sourceUrl: 'https://www.douban.com/people/Utopia19910619'},
				{name: '微博', sourceUrl: 'http://weibo.com/p/1005052619492527/home'}
			],
			timer: '',
			cartStatus: false
		}
